...
public class User {
    ...
    //Constructor
    public User(int user_id, String first_name,String last_name, String email, String password, int access_level, String creation_date, int account_status, String user_name, int otp ){
